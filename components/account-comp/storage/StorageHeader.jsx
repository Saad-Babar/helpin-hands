...
const projectOptions = [
    ...
    { value: "box", label: "Box", img: '/admin-images/storage-icons/box.png' },
    { value: "dropbox", label: "Dropbox", img: '/admin-images/storage-icons/dropbox.png ' },
    { value: "onedrive", label: "Onedrive", img: '/admin-images/storage-icons/onedrive.png' },
    { value: "g-drive", label: "G-Drive", img: '/admin-images/storage-icons/google-drive.png' },
    { value: "local", label: "Local", img: '/admin-images/storage-icons/local-storage.png' },
]
