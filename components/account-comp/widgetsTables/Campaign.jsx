...
const campaignData = [
    { brand: 'Facebook', image: '/admin-images/brand/facebook.png', link: 'http://ads.facebook.com/#campaign', target: '50K', reach: '46.44K', progress: 92, status: 'Active', actions: ['Pause', 'Stop'], color: "primary" },
    { brand: 'Gmail', image: '/admin-images/brand/gmail.png', link: 'http://ads.google.com/#campaign', target: '30K', reach: '22.82K', progress: 82, status: 'Paused', actions: ['Pause', 'Play'], color: "warning" },
    { brand: 'Twitter', image: '/admin-images/brand/twitter.png', link: 'http://ads.twitter.com/#campaign', target: '40K', reach: '35.2K', progress: 88, status: 'Active', actions: ['Pause', 'Stop'], color: "primary" },
    { brand: 'Pinterest', image: '/admin-images/brand/pinterest.png', link: 'http://ads.pinterest.com/#campaign', target: '60K', reach: '55.1K', progress: 91, status: 'Active', actions: ['Pause', 'Stop'], color: "success" },
    { brand: 'Instagram', image: '/admin-images/brand/instagram.png', link: 'http://ads.instagram.com/#campaign', target: '25K', reach: '18.6K', progress: 74, status: 'Paused', actions: ['Pause', 'Play'], color: "primary" },
];
