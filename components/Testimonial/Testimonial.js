...
const Testimonial = () => {
    ...
    return (
        ...
        <section className="review pt-110 pb-100 position-relative overflow-hidden cc-slide-wrap3">
            <Image src={shape1} alt="Gainioz Shape" className="review__shape review__shape--one" />
            <Image src={shape2} alt="Gainioz Shape" className="review__shape review__shape--two" />
            <div className="mask mask--review position-absolute">
                <Image src={man} alt="Gainioz Shape" className="mask__thumb" />
                <Image className="mask__overlay" src={shape3} alt="Gainioz Shape" />
            </div>
                    ...
                    <div className="col-12">
                        <div className="review__box mb-30">
                            ...
                            <ul className="review__box__images">
                                <li><Image src={tImg2} alt="Gainioz Reviewer" /></li>
                                <li><Image src={tImg3} alt="Gainioz Reviewer" /></li>
                                <li><Image src={tImg4} alt="Gainioz Reviewer" /></li>
                                <li><Image src={tImg5} alt="Gainioz Reviewer" /></li>
                            </ul>
                                        ...
                                        {testimonial.map((testimonial, tsm) => (
                                            <SwiperSlide key={tsm}>
                                                <div className="reviewblock__content">
                                                    <Image className="reviewblock__author__image" src={testimonial.tImg} alt="Gainioz Reviewer" />
